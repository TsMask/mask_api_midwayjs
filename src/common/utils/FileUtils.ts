 ...
 * @return 文件名
 */
export async function writeBufferFile(buf: Buffer, writeDirPath: string): Promise<string> {
 ...
 */
export async function transferToNewFile(readFile: string, writePath: string, fileName: string): Promise<void> {
